...
export const boardList = async ({bd_idx, bd_title, mem_userid, bd_regDate, page }) => 
    await axios.get(`http://3.36.66.15:5000/api/boardList/${page}`, {
    bd_idx, bd_title,  mem_userid, bd_regDate, page
})

// export const boardList = async ({bd_idx, bd_title, mem_userid, bd_regDate, page }) => 
//     await axios.get(`/api/boardList/${page}`, {
//     bd_idx, bd_title,  mem_userid, bd_regDate, page
// })
